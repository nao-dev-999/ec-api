...
class ProductReviewControllerTest {
    ...
    class ListByProductTest {
        ...
        void shouldReturnReviewsAndSummary() throws Exception {
            when(reviewService.listByProduct(10L)).thenReturn(List.of(reviewResult));
            ...
            mockMvc.perform(get("/api/customer/products/{productId}/reviews", 10L))
                    ...
                    .andExpect(jsonPath("$.reviews[0].id").value(reviewResult.id()))
        ...
        void shouldReturnEmptyWhenNoReviews() throws Exception {
            when(reviewService.listByProduct(10L)).thenReturn(Collections.emptyList());
        ...
        void shouldReturnNotFoundWhenProductDoesNotExist() throws Exception {
            when(reviewService.listByProduct(99L)).thenThrow(new ProductNotFoundException(99L));
