...
class AdminEmployeeControllerTest {
    ...
    class GetAllEmployeesTest {
        ...
        void shouldGetAllEmployees() throws Exception {
            ...
            mockMvc.perform(get("/api/admin/employees"))
                    ...
                    .andExpect(jsonPath("$[0].role").value(employeeResponse.role()));
        }
    ...
    class GetEmployeeByIdTest {
        ...
        void shouldGetEmployeeById() throws Exception {
            ...
            mockMvc.perform(get("/api/admin/employees/{id}", 1L))
                    ...
                    .andExpect(jsonPath("$.role").value(employeeResponse.role()));
        }
    ...
    class CreateEmployeeTest {
        ...
        void shouldCreateEmployee() throws Exception {
            CreateEmployeeRequest request =
                    new CreateEmployeeRequest("new@example.com", "password123", "STAFF");
        ...
        void shouldReturnBadRequestWhenValidationFails() throws Exception {
            CreateEmployeeRequest invalidRequest =
                    new CreateEmployeeRequest("not-an-email", "short", "");
        ...
        void shouldReturnConflictWhenEmailDuplicate() throws Exception {
            CreateEmployeeRequest request =
                    new CreateEmployeeRequest("admin@example.com", "password123", "ADMIN");
    ...
    class UpdateEmployeeRoleTest {
        ...
        void shouldUpdateEmployeeRole() throws Exception {
            UpdateEmployeeRoleRequest request = new UpdateEmployeeRoleRequest("STAFF", 0);
        ...
        void shouldReturnBadRequestWhenRoleIsBlank() throws Exception {
            UpdateEmployeeRoleRequest invalidRequest = new UpdateEmployeeRoleRequest("", 0);
